...
heroes.forEach((hero) => {
    ...
    heroCard.innerHTML = `<div class="heading">
                <h2>${hero.name}</h2>
                <button type="button" class="info click" data-url="${hero.url}">Click!</button>
            </div>
            <div class="info">
            ...
            <div class="star-rating" data-url="${hero.url}">
                <button class="star" data-url="${hero.url}">&#9734</button>
                <button class="star" data-url="${hero.url}">&#9734</button>
                <button class="star" data-url="${hero.url}">&#9734</button>
                <button class="star" data-url="${hero.url}">&#9734</button>
                <button class="star" data-url="${hero.url}">&#9734</button>
    ...
    popup.textContent = hero.info;
    popup.setAttribute('data-url', hero.url)
    popup.classList.add('popuptext');
    heroCard.appendChild(popup);
    const infoButton = document.querySelectorAll('.info');
    for (let button of infoButton) {
        button.addEventListener('click', (event) => {
            if (event.target.dataset.url === popup.dataset.url) {
