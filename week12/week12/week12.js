...
const makeFifteen = () => {
	const str = 'JavaScript';
	resultFifteen.textContent = str.toLocaleUpperCase();
};
...
const makeTwentyOne = () => {
	...
	resultTwentyOne.textContent = Math.floor(randomNumber); 
};
...
const makeTwentySix = () => {
	...
	resultTwentySix.textContent = randomNumber.toFixed(4);
};
...
const makeTwentySeven = () => {
	resultTwentySeven.textContent = Math.floor(Math.random() * 51 + 50);
};
