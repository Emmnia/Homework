...
document.querySelector('.b-0').onclick = function () {
...
function makeTwo() {
	practicum2.innerText = "Привет, Мир!";
}
...
function makeEight() {
	...
	const y = document.createElement('li'); //Создайте новый пункт списка y
	y.textContent = "Новый элемент"; //Добавьте значение в созданный пункт списка y
	x.append(y); //Добавьте в список х новый элемент y
}
...
function makeNine() {
	const select = document.getElementById('practicum9');//Найдите элемент
	const option = document.createElement('option');//Создайте новый элемент
	option.innerText = "Новый вариант";//Добавьте текст в созданный эелемент
	select.append(option);//Добавьте новый элемент в выпадающий список
}
...
function makeThirteen() {
	const pr13 = document.getElementsByTagName("ol")[0];
	pr13.textContent = "Первый!";
}
...
function makeFifteen() {
	const pr15 = document.getElementById('practicum15');
	pr15.classList.remove('practicum15');
}
...
function makeSixteen() {
	const pr16 = document.getElementById('practicum16');
	pr16.classList.add('practicum16');
}
...
function makeSeventeen() {
	const pr17 = document.getElementById('practicum17');
	pr17.classList.toggle('color');
}
...
function makeEighteen() {
	const pr18 = document.getElementById('practicum18');
	pr18.classList.toggle('active');
}
...
function makeNineteen() {
	const pr19 = document.getElementById('practicum19');
	pr19.classList.remove('active');
}
...
function makeTwenty() {
	...
	y.textContent = "Добавлено в начало";
	x.prepend(y);
}
...
function makeTwentyOne() {
	...
	const y = document.createElement('p');
	y.textContent = "Добавлено в конец";
	x.append(y);
}
...
function makeTwentyTwo() {
	const image = document.getElementById('practicum22');//1 шаг: Найдите элемент
	const checkAttribute = image.hasAttribute('src');//2 шаг: Создайте переменную, которая проверяет наличие атрибута у найденного элемента
	const result = document.getElementById('result22');//3 шаг: Найдите элемент, в который нужно вставить значение
	result.textContent = 'Атрибут "src" присутствует: ' +  checkAttribute;//4 шаг: Добавьте в эелемент текстовое значение 2 шага. Например: переменная = 'Атрибут "src" присутствует: ' + название переменной из 2 шага;
}
...
function makeTwentyFive() {
	const pr25 = document.getElementById('practicum25');//1 шаг: Найдите элемент
	pr25.setAttribute('data-info', 'Дополнительная информация');//2 шаг: Добавьте элементу, найденному в первом шаге, атрибут: 
	const info = pr25.getAttribute('data-info');//3 шаг: Запишите значение атрибута в переменную
	const infoOutput = document.getElementById('infoOutput');//4 шаг: Найдите элемент, в который нужно вставить значение из 3 шага
	infoOutput.textContent = 'Добавленный атрибут: ' + info;//5 шаг: Добавьте в элемент 4 шага текстовое значение 3 шага. Например: переменная = 'Добавленный атрибут: ' + название переменной из 3 шага;
}
...
function makeTwentySeven() {
	const pr27 = document.getElementById('practicum27');
	const result = pr27.classList.contains('highlight');//Создайте переменную и сохраните в неё результат проверки метода contains. Например: 
	const resultOutput = document.getElementById('result');//Найдите переменную, в которую нужно вывести результат
