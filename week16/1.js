...
const brandChoice = form.elements.brand;
const makeChoice = form.elements.make;
const fuelChoice = form.elements.fuel;
const ageChoice = form.elements.age;
const ownersChoice = form.elements.owners;
const paymentChoice = form.elements.payment;
...
const updateMakeListeners = () => {
	const makes = Array.from(document.querySelectorAll('.make'));
	makes.forEach((make) => {
		make.addEventListener('change', makeUpdate);
	});
};
	...
	switch (brandChoice.value) {
		case 'Renault':
			makeChoice.innerHTML =
				'<option class="make" id="rafale" value="Rafale">Rafale</option><option class="make" id="express" value="Express">Express</option><option class="make" id="megane" value="Megane E-Tech">Megane E-Tech</option><option class="make" id="arkana" value="Arkana">Arkana</option>';
			break;
		case 'Opel':
			makeChoice.innerHTML =
				'<option class="make" id="zafira" value="Zafira Life">Zafira Life</option><option class="make" id="grandland" value="Grandland">Grandland</option><option class="make" id="combo" value="Combo">Combo</option><option class="make" id="vivaro" value="Vivaro">Vivaro</option>';
			break;
		case 'Mazda':
			makeChoice.innerHTML =
				'<option class="make" id="CX30" value="CX-30">CX-30</option><option class="make" id="CX5" value="CX-5">CX-5</option><option class="make" id="CX60" value="CX-60">CX-60</option><option class="make" id="six" value="6">6</option>';
			break;
		case 'Jaguar':
			makeChoice.innerHTML =
				'<option class="make" id="epace" value="E-Pace">E-Pace</option><option class="make" id="XE" value="XE">XE</option><option class="make" id="fpace" value="F-Pace">F-Pace</option><option class="make" id="XF" value="XF">XF</option>';
			break;
		default:
			makeChoice.innerHTML =
...
// Инициализация слушателей для радиокнопок топлива
fuel.forEach((el) => {
